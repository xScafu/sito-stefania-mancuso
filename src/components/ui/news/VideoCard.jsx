  ...
  let videoCard = videoArray.map((video) => (
    <>
      <iframe
        ...
        className="mt-20"
      ></iframe>
      <h1 className="text-apricot dark:text-englishViolet text-xl mt-5 font-semibold dark:font-bold">
        {video.name}
      </h1>
      <hr className="mt-20 border-apricot dark:border-englishViolet" />
    </>
  ));
